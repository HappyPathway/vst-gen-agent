---
name: "VST Gen"
description: "Use when: generating a new VST plugin for a hardware MIDI device; running /new-device to start the capture workflow; analyzing device screenshots or panel images; building JUCE plugin scaffolding; capturing NRPN parameters from hardware; mapping knobs from a front-panel photo; reading a device manual to extract parameters."
tools: [read, edit, search, execute, todo, vscode_askQuestions]
argument-hint: "Device name or /new-device to start the full guided workflow"
---
